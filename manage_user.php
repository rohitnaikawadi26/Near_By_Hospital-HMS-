            ...
            <?php
             ...
             while($data=mysqli_fetch_array($res)){
                ...
                <tr>
                    ...
                    <!-- <td>
                        <a href="edit_user.php?id=<?php echo $data['id']?>" class="text-success"><i class="fa fa-edit"></i></a>
                    </td>
                    <td>
                        <a href="delete_user.php?id=<?php echo $data['id']?>" class="text-danger"><i class="fa fa-trash"></i></a>
                    </td> -->
                </tr>
                <?php
                $sno++;
