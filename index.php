                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
                            <div class="hero__caption">
                                ...
                                <a href="my_appointment.php" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">Appointment <i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>          
                ...
                <div class="col-lg-6 col-md-10">
                    <div class="about-caption mb-50">
                        ...
                        <div class="about-btn1 mb-30">
                            <a href="ambulance.php" class="btn about-btn">Ambulance .<i class="ti-arrow-right"></i></a>
                        </div>
                        <div class="about-btn1 mb-30">
                            <a href="hospital.php" class="btn about-btn2">Find Doctors <i class="ti-arrow-right"></i></a>
                        </div>
                        <div class="about-btn1 mb-30">
                            <a href="emergency.php" class="btn about-btn2"> Emergency <i class="ti-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center no-gutters">
                            <div class="col-lg-7">
                                <div class="dept_info">
                                    ...
                                    <p>Our Website Provides help to find ambulance contact numbers and hospitals at different location with services. </p>
                                    <a href="my_appointment.php" class="dep-btn">Appointment<i class="ti-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-5">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blogs mb-30">
                        ...
                        <div class="blogs-cap">
                            ...
                            <h4><a href="blog_details.php">Amazing Places To Visit In Summer</a></h4>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blogs mb-30">
                        ...
                        <div class="blogs-cap">
                            ...
                            <h4><a href="blog_details.php">Developing Creativithout Losing Visual</a></h4>
                            <a href="blog_details.php" class="read-more1">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-blogs mb-30">
                        ...
                        <div class="blogs-cap">
                            ...
                            <h4><a href="blog_details.php">Winter Photography Tips from Glenn</a></h4>
                            <a href="blog_details.php" class="read-more1">Read more</a>
                        </div>
                    </div>
                </div>
