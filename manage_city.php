            ...
            <?php
             ...
             while($data=mysqli_fetch_array($res)){
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_city.php?id=<?php echo $data['id']?>" class="text-success"><i class="fa fa-edit"></i></a>
                    </td>
                    <td>
                        <a href="delete_city.php?id=<?php echo $data['id']?>" class="text-danger"><i class="fa fa-trash"></i></a>
                    </td>
                    </td>
                </tr>
                <?php
